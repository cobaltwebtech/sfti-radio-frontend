/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c4a918ae94a0e919e882c49dd37bccbd)
// Runtime types generated with workerd@1.20260301.1 2026-02-15 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		ASSETS: Fetcher;
		PUBLIC_UMAMI_ID: "61e9bff4-c8e7-4938-af7a-b10ff731acc3";
		PAYLOAD_API_URL: string;
		PUBLIC_R2_URL: string;
		RESEND_API_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		PUBLIC_TURNSTILE_SITE_KEY: string;
		PAYLOAD_CMS_WORKER: Fetcher /* sfti-radio-cms */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_UMAMI_ID" | "PAYLOAD_API_URL" | "PUBLIC_R2_URL" | "RESEND_API_KEY" | "TURNSTILE_SECRET_KEY" | "PUBLIC_TURNSTILE_SITE_KEY">> {}
}
